...
1. Go To 👉 https://icashfly.com/member/tools/api  
2. Than Copy API Key
...
Ex: https://t.me/shortnerfly | icashfly"""
...
START_MESSAGE_REPLY_MARKUP  = InlineKeyboardMarkup([
    [
        InlineKeyboardButton('Get Api', url=f'https://icashfly.com/member/tools/api')
    ]
])
...
USER_ABOUT_MESSAGE = """
- Website: [{base_site}](https://icashfly/ref/admin)
...
Get API From [{base_site}](https://icashfly/ref/admin)
...
USERNAME_TEXT = """**Hello Harman, I am icashfly.com, Bulk Link Converter Bot From Linked icashfly.com Account,**
